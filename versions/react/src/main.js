...
import smile from '../../Resources/images/smile.jpg';
import train from '../../Resources/images/dark_train.jpg';
import './App.css';
                ...
                <div className="card mb-4 bg-dark border-danger">
                  <div className="card-body">
                    <div>
                      ...
                      >
                        <img src={smile} width="225" alt="logo" />
                      </a>
                    </div>
                    &nbsp;
                    <p></p>
                    <div className="input-group mb-4">
                      ...
                      <div className="input-group-append">
                        <div className="input-group-text">
                          <img src={train} height="20" alt=""/>&nbsp;<b>ETH</b>
                        </div>
                      </div>
                    </div>
                    <button
